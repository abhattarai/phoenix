...
const setTrustedServer = function (url) {
  ...
  const postUrl = path.join(backendHelper.getCurrentBackendUrl(), '/ocs/v2.php/apps/testing/api/v1/trustedservers?format=json')
...
After(async function (testCase) {
  ...
  await fetch(path.join(client.globals.backend_url, '/ocs/v2.php/apps/testing/api/v1/lockprovisioning'),
